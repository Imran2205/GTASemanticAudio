//
//  VideoFrmaeViewController.swift
//  GTASemanticAudio
//
...
class VideoFrmaeViewController: UIViewController, AVSpeechSynthesizerDelegate  {
    ...
    func get_image(){
        ...
        video_frames = Int(durationInSeconds) / frame_jump

        let t = CMTime(value: CMTimeValue(self.img_id*frame_jump), timescale: CMTimeScale(vid_time_scale))
    ...
    func show_image(){
        DispatchQueue.main.async { [self] in
            ...
            for cls in self.json_polygon_data.frame_data[self.img_id * img_id_multiplier].classes {
